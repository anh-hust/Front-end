/* INFO: take position through IP address and mark on map, add event click too*/
// function setup for p5, p5 read the function setup() first to execute
function setup() {
  noCanvas();
  ...
  if (navigator.geolocation)
    navigator.geolocation.getCurrentPosition(
      function (position) {
        ...
        L.marker(coords)
          .addTo(map)
          .bindPopup("Your destIP position")
          .openPopup();
